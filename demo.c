...
int main(void) {
	struct mkgui_widget widgets[] = {
		...
		{ MKGUI_TAB,      ID_TAB2,      "Data",              "", ID_TABS,     0,  0,  0,  0, 0 },
		...
		{ MKGUI_GROUP,    ID_GRP_INPUT, "Settings",          "", ID_TAB1,    10, 10, 400, 170, 0 },
		{ MKGUI_LABEL,    ID_LABEL1,    "Name:",             "", ID_GRP_INPUT, 0, 0, 60, 24, 0 },
		{ MKGUI_INPUT,    ID_INPUT1,    "",                  "", ID_GRP_INPUT, 70, 0, 250, 24, 0 },
		{ MKGUI_CHECKBOX, ID_CHECK1,    "Enable feature",    "", ID_GRP_INPUT, 0, 34, 200, 24, 0 },
		{ MKGUI_DROPDOWN, ID_DROPDOWN1, "Mode",              "", ID_GRP_INPUT, 0, 68, 200, 24, 0 },
		{ MKGUI_SLIDER,   ID_SLIDER1,   "Volume",            "", ID_GRP_INPUT, 0, 120, 300, 20, 0 },

		{ MKGUI_GROUP,    ID_GRP_RADIO, "Priority",          "", ID_TAB1,    10, 190, 400, 60, 0 },
		{ MKGUI_RADIO,    ID_RADIO1,    "Low",               "", ID_GRP_RADIO, 0, 0, 100, 24, MKGUI_CHECKED },
		{ MKGUI_RADIO,    ID_RADIO2,    "Medium",            "", ID_GRP_RADIO, 100, 0, 100, 24, 0 },
		{ MKGUI_RADIO,    ID_RADIO3,    "High",              "", ID_GRP_RADIO, 200, 0, 100, 24, 0 },

		{ MKGUI_LABEL,    ID_PROG_LBL,  "Progress:",         "", ID_TAB1,    10, 264, 80, 24, 0 },
		{ MKGUI_PROGRESS, ID_PROGRESS1, "",                  "", ID_TAB1,    90, 264, 300, 20, 0 },
		{ MKGUI_SPINNER,  ID_SPINNER1,  "",                  "", ID_TAB1,   400, 258, 28, 28, 0 },

		{ MKGUI_LABEL,    63,           "Count:",            "", ID_TAB1,    10, 298, 60, 24, 0 },
		{ MKGUI_SPINBOX,  ID_SPINBOX1,  "",                  "", ID_TAB1,    80, 298, 120, 24, 0 },

		{ MKGUI_BUTTON,   ID_BUTTON1,   "Apply",             "", ID_TAB1,    10, 340, 100, 28, 0 },

		{ MKGUI_CHECKBOX, ID_THEME_CHECK,"Light theme",      "brightness-6", ID_TAB1,   10, 380, 200, 24, 0 },

		{ MKGUI_LABEL,    ID_TREE_LBL,  "Project tree:",     "", ID_TAB3,    10, 10, 200, 24, 0 },
		{ MKGUI_TREEVIEW, ID_TREEVIEW1, "",                  "", ID_TAB3,    10, 40, 300, 10, MKGUI_ANCHOR_LEFT | MKGUI_ANCHOR_TOP | MKGUI_ANCHOR_BOTTOM },

		{ MKGUI_LABEL,    ID_TEXT_LBL,  "Notes:",            "", ID_TAB3,   320, 10, 200, 24, 0 },
		{ MKGUI_TEXTAREA, ID_TEXTAREA1, "",                  "", ID_TAB3,   320, 40, 10, 10, MKGUI_ANCHOR_LEFT | MKGUI_ANCHOR_TOP | MKGUI_ANCHOR_RIGHT | MKGUI_ANCHOR_BOTTOM },

		{ MKGUI_BUTTON,   ID_IV_ICON,   "Icons",             "", ID_TAB5,   10,  10, 70, 24, 0 },
		{ MKGUI_BUTTON,   ID_IV_THUMB,  "Thumbnails",        "", ID_TAB5,   85,  10, 90, 24, 0 },
		{ MKGUI_BUTTON,   ID_IV_COMPACT,"Compact",           "", ID_TAB5,  180,  10, 70, 24, 0 },
		{ MKGUI_BUTTON,   ID_IV_DETAIL, "Detail",            "", ID_TAB5,  255,  10, 70, 24, 0 },
		{ MKGUI_ITEMVIEW, ID_ITEMVIEW1, "",                  "", ID_TAB5,   10,  44, 10, 20, MKGUI_ANCHOR_LEFT | MKGUI_ANCHOR_TOP | MKGUI_ANCHOR_RIGHT | MKGUI_ANCHOR_BOTTOM },

		{ MKGUI_TAB,      ID_TAB7,      "Layout",            "", ID_TABS,     0,  0,  0,  0, 0 },
		{ MKGUI_HBOX,     ID_HBOX1,     "",                  "", ID_TAB7,     10, 10, 10, 10, MKGUI_ANCHOR_LEFT | MKGUI_ANCHOR_TOP | MKGUI_ANCHOR_RIGHT | MKGUI_ANCHOR_BOTTOM },
		...
		{ MKGUI_PANEL,    ID_PANEL1,    "",                  "", ID_TAB6,    10,  10, 300, 120, MKGUI_PANEL_BORDER | MKGUI_PANEL_SUNKEN },
		...
		{ MKGUI_LABEL,    ID_SB_LBL,    "Scrollbar:",        "", ID_TAB6,    10, 140, 100, 20, 0 },
		{ MKGUI_SCROLLBAR,ID_SCROLLBAR1,"",                  "", ID_TAB6,    10, 164, MKGUI_SCROLLBAR_W, 200, 0 },
		{ MKGUI_LABEL,    ID_IMG_LBL,   "Image:",            "", ID_TAB6,   340,  10, 100, 20, 0 },
		{ MKGUI_IMAGE,    ID_IMAGE1,    "",                  "", ID_TAB6,   340,  34, 200, 200, MKGUI_PANEL_BORDER },
		{ MKGUI_LABEL,    ID_GL_LBL,    "OpenGL:",           "", ID_TAB6,    40, 140, 100, 20, 0 },
		{ MKGUI_GLVIEW,   ID_GLVIEW1,   "",                  "", ID_TAB6,    40, 164, 300, 200, MKGUI_PANEL_BORDER },

		{ MKGUI_LABEL,    ID_LABEL2,    "Data list (1M rows):", "", ID_TAB4, 10, 10, 200, 24, 0 },
		{ MKGUI_LISTVIEW, ID_LISTVIEW1, "",                  "", ID_TAB4,    10, 40, 10, 20, MKGUI_ANCHOR_LEFT | MKGUI_ANCHOR_TOP | MKGUI_ANCHOR_RIGHT | MKGUI_ANCHOR_BOTTOM | MKGUI_VIRTUAL },
