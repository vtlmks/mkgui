...
int main(void) {
	struct mkgui_widget widgets[] = {
		...
		{ MKGUI_MENUITEM, ID_VIEW_GRID, "Show Grid",         "grid",         ID_VIEW_MENU, 0, 0, 0, MKGUI_MENU_CHECK | MKGUI_CHECKED, 0 },
		{ MKGUI_MENUITEM, ID_VIEW_STATUS,"Show Statusbar",   "dock-bottom",  ID_VIEW_MENU, 0, 0, 0, MKGUI_MENU_CHECK | MKGUI_CHECKED, 0 },
		...
		{ MKGUI_TAB,      ID_TAB_CONTROLS, "Controls",       "cog",       ID_TABS, 0, 0, 0, 0, 0 },
		{ MKGUI_TAB,      ID_TAB_TREE,     "Tree / Text",    "folder",    ID_TABS, 0, 0, 0, 0, 0 },
		{ MKGUI_TAB,      ID_TAB_DATA,     "Data Views",     "view-list", ID_TABS, 0, 0, 0, 0, 0 },
		{ MKGUI_TAB,      ID_TAB_LAYOUT,   "Layout",         "view-dashboard", ID_TABS, 0, 0, 0, 0, 0 },
		{ MKGUI_TAB,      ID_TAB_MEDIA,    "Media",          "image",     ID_TABS, 0, 0, 0, 0, 0 },
