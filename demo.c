...
int main(void) {
	struct mkgui_widget widgets[] = {
		{ MKGUI_WINDOW,   ID_WINDOW,    "mkgui demo",       "",  0,           1000, 700, 0, 0 },

		/* Menu bar */
		{ MKGUI_MENU,     ID_MENU,      "",                  "", ID_WINDOW,   0, 0, 0, 0 },
		{ MKGUI_MENUITEM, ID_FILE_MENU, "File",              "", ID_MENU,     0, 0, 0, 0 },
		{ MKGUI_MENUITEM, ID_EDIT_MENU, "Edit",              "", ID_MENU,     0, 0, 0, 0 },
		{ MKGUI_MENUITEM, ID_VIEW_MENU, "View",              "", ID_MENU,     0, 0, 0, 0 },
		{ MKGUI_MENUITEM, ID_HELP_MENU, "Help",              "", ID_MENU,     0, 0, 0, 0 },
		{ MKGUI_MENUITEM, ID_FILE_NEW,  "New",               "file-plus",    ID_FILE_MENU, 0, 0, 0, 0 },
		{ MKGUI_MENUITEM, ID_OPEN,      "Open",              "folder-open",  ID_FILE_MENU, 0, 0, 0, 0 },
		{ MKGUI_MENUITEM, ID_SAVE,      "Save",              "content-save", ID_FILE_MENU, 0, 0, 0, 0 },
		{ MKGUI_MENUITEM, ID_FILE_SEP1, "",                  "",             ID_FILE_MENU, 0, 0, MKGUI_SEPARATOR, 0 },
		{ MKGUI_MENUITEM, ID_EXIT,      "Exit",              "exit-to-app",  ID_FILE_MENU, 0, 0, 0, 0 },
		{ MKGUI_MENUITEM, ID_EDIT_CUT,  "Cut",               "content-cut",  ID_EDIT_MENU, 0, 0, 0, 0 },
		{ MKGUI_MENUITEM, ID_COPY,      "Copy",              "content-copy", ID_EDIT_MENU, 0, 0, 0, 0 },
		{ MKGUI_MENUITEM, ID_PASTE,     "Paste",             "content-paste",ID_EDIT_MENU, 0, 0, 0, 0 },
		{ MKGUI_MENUITEM, ID_VIEW_GRID, "Show Grid",         "grid",         ID_VIEW_MENU, 0, 0, MKGUI_MENU_CHECK | MKGUI_CHECKED, 0 },
		{ MKGUI_MENUITEM, ID_VIEW_STATUS,"Show Statusbar",   "dock-bottom",  ID_VIEW_MENU, 0, 0, MKGUI_MENU_CHECK | MKGUI_CHECKED, 0 },
		{ MKGUI_MENUITEM, ID_VIEW_SEP1, "",                  "",             ID_VIEW_MENU, 0, 0, MKGUI_SEPARATOR, 0 },
		{ MKGUI_MENUITEM, ID_VIEW_SMALL,"Small",             "",             ID_VIEW_MENU, 0, 0, MKGUI_MENU_RADIO, 0 },
		{ MKGUI_MENUITEM, ID_VIEW_MEDIUM,"Medium",           "",             ID_VIEW_MENU, 0, 0, MKGUI_MENU_RADIO | MKGUI_CHECKED, 0 },
		{ MKGUI_MENUITEM, ID_VIEW_LARGE,"Large",             "",             ID_VIEW_MENU, 0, 0, MKGUI_MENU_RADIO, 0 },
		{ MKGUI_MENUITEM, ID_HELP_ABOUT,"About",             "information",  ID_HELP_MENU, 0, 0, 0, 0 },

		/* Toolbar */
		{ MKGUI_TOOLBAR,  ID_TOOLBAR,   "",                  "", ID_WINDOW,   0, 0, 0, 0 },
		{ MKGUI_BUTTON,   ID_TB_NEW,    "New",               "file-plus",    ID_TOOLBAR, 0, 0, 0, 0 },
		{ MKGUI_BUTTON,   ID_TB_SEP1,   "",                  "",             ID_TOOLBAR, 0, 0, MKGUI_SEPARATOR, 0 },
		{ MKGUI_BUTTON,   ID_TB_OPEN,   "Open",              "folder-open",  ID_TOOLBAR, 0, 0, 0, 0 },
		{ MKGUI_BUTTON,   ID_TB_SAVE,   "Save",              "content-save", ID_TOOLBAR, 0, 0, 0, 0 },

		/* Tabs */
		{ MKGUI_TABS,     ID_TABS,      "",                  "", ID_WINDOW,   0, 0, 0, 0 },
		{ MKGUI_TAB,      ID_TAB_CONTROLS, "Controls",       "cog",       ID_TABS, 0, 0, 0, 0 },
		{ MKGUI_TAB,      ID_TAB_TREE,     "Tree / Text",    "folder",    ID_TABS, 0, 0, 0, 0 },
		{ MKGUI_TAB,      ID_TAB_DATA,     "Data Views",     "view-list", ID_TABS, 0, 0, 0, 0 },
		{ MKGUI_TAB,      ID_TAB_LAYOUT,   "Layout",         "view-dashboard", ID_TABS, 0, 0, 0, 0 },
		{ MKGUI_TAB,      ID_TAB_MEDIA,    "Media",          "image",     ID_TABS, 0, 0, 0, 0 },

		/* ---- Controls tab ---- */
		{ MKGUI_HBOX,     ID_CTL_HBOX,  "",                  "", ID_TAB_CONTROLS, 0, 0, 0, 0 },
		...
		{ MKGUI_LABEL,    ID_LBL_ENABLE,"Enable:",           "", ID_CTL_FORM, 0, 0, 0, 0 },
		{ MKGUI_CHECKBOX, ID_CHECK1,    "Enable feature",    "", ID_CTL_FORM, 0, 0, 0, 0 },
		{ MKGUI_LABEL,    ID_LBL_MODE,  "Mode:",             "", ID_CTL_FORM, 0, 0, 0, 0 },
		{ MKGUI_DROPDOWN, ID_DROPDOWN1, "",                  "", ID_CTL_FORM, 0, 0, 0, 0 },
		{ MKGUI_LABEL,    ID_LBL_SEARCH,"Search:",           "", ID_CTL_FORM, 0, 0, 0, 0 },
		{ MKGUI_COMBOBOX, ID_COMBOBOX1, "",                  "", ID_CTL_FORM, 0, 0, 0, 0 },
		...
		{ MKGUI_RADIO,    ID_RADIO3,    "High",              "", ID_RADIO_HBOX, 0, 0, 0, 1 },

		{ MKGUI_HBOX,     ID_PROG_HBOX, "",                  "", ID_CTL_LVBOX, 0, 28, MKGUI_FIXED, 0 },
		{ MKGUI_LABEL,    ID_PROG_LBL,  "Progress:",         "", ID_PROG_HBOX, 80, 0, MKGUI_FIXED, 0 },
		{ MKGUI_PROGRESS, ID_PROGRESS1, "",                  "", ID_PROG_HBOX, 0, 0, 0, 1 },
		{ MKGUI_SPINNER,  ID_SPINNER1,  "",                  "", ID_PROG_HBOX, 28, 0, MKGUI_FIXED, 0 },

		{ MKGUI_HBOX,     ID_METER_HBOX,"",                  "", ID_CTL_LVBOX, 0, 28, MKGUI_FIXED, 0 },
		{ MKGUI_LABEL,    ID_METER_LBL, "Meter:",            "", ID_METER_HBOX, 80, 0, MKGUI_FIXED, 0 },
		{ MKGUI_METER,    ID_METER1,    "",                  "", ID_METER_HBOX, 0, 0, MKGUI_METER_TEXT, 1 },

		{ MKGUI_HBOX,     ID_COUNT_HBOX,"",                  "", ID_CTL_LVBOX, 0, 24, MKGUI_FIXED, 0 },
		{ MKGUI_LABEL,    ID_LBL_COUNT, "Count:",            "", ID_COUNT_HBOX, 80, 0, MKGUI_FIXED, 0 },
		{ MKGUI_SPINBOX,  ID_SPINBOX1,  "",                  "", ID_COUNT_HBOX, 120, 0, MKGUI_FIXED, 0 },

		{ MKGUI_HBOX,     ID_BTN_HBOX,  "",                  "", ID_CTL_LVBOX, 0, 28, MKGUI_FIXED, 0 },
		{ MKGUI_BUTTON,   ID_BUTTON1,   "Apply",             "", ID_BTN_HBOX, 100, 0, MKGUI_FIXED, 0 },
		{ MKGUI_SPACER,   ID_SPACER1,   "",                  "", ID_BTN_HBOX, 0, 0, 0, 1 },
		{ MKGUI_CHECKBOX, ID_THEME_CHECK,"Light theme",      "brightness-6", ID_BTN_HBOX, 140, 0, MKGUI_FIXED, 0 },

		/* Controls: right column */
		{ MKGUI_VBOX,     ID_CTL_RVBOX, "",                  "", ID_CTL_HBOX, 280, 0, MKGUI_FIXED, 0 },
		{ MKGUI_GROUP,    ID_GRP_EXTRA, "Extra Controls",    "", ID_CTL_RVBOX, 0, 0, 0, 1 },
		{ MKGUI_FORM,     ID_EXTRA_FORM,"",                  "", ID_GRP_EXTRA, 0, 0, 0, 0 },
		{ MKGUI_LABEL,    ID_LBL_POWER, "Power:",            "", ID_EXTRA_FORM, 0, 0, 0, 0 },
		{ MKGUI_TOGGLE,   ID_TOGGLE1,   "",                  "", ID_EXTRA_FORM, 0, 0, 0, 0 },
		{ MKGUI_LABEL,    ID_LBL_DATE,  "Date:",             "", ID_EXTRA_FORM, 0, 0, 0, 0 },
		{ MKGUI_DATEPICKER, ID_DATEPICKER1, "",              "", ID_EXTRA_FORM, 0, 0, 0, 0 },
		{ MKGUI_LABEL,    ID_LBL_IP,    "IP Address:",       "", ID_EXTRA_FORM, 0, 0, 0, 0 },
		{ MKGUI_IPINPUT,  ID_IPINPUT1,  "",                  "", ID_EXTRA_FORM, 0, 0, 0, 0 },
		{ MKGUI_LABEL,    ID_LBL_TBMODE,"Toolbar:",          "", ID_EXTRA_FORM, 0, 0, 0, 0 },
		{ MKGUI_DROPDOWN, ID_TBMODE_DROP,"",                 "", ID_EXTRA_FORM, 0, 0, 0, 0 },

		/* ---- Tree / Text tab ---- */
		{ MKGUI_VSPLIT,   ID_TREE_SPLIT,"",                  "", ID_TAB_TREE, 0, 0, 0, 0 },
		{ MKGUI_VBOX,     ID_TREE_LVBOX,"",                  "", ID_TREE_SPLIT, 0, 0, MKGUI_REGION_LEFT, 0 },
		{ MKGUI_LABEL,    ID_TREE_LBL,  "Project tree:",     "", ID_TREE_LVBOX, 0, 20, MKGUI_FIXED, 0 },
		{ MKGUI_TREEVIEW, ID_TREEVIEW1, "",                  "", ID_TREE_LVBOX, 0, 0, 0, 1 },
		{ MKGUI_VBOX,     ID_TREE_RVBOX,"",                  "", ID_TREE_SPLIT, 0, 0, MKGUI_REGION_RIGHT, 0 },
		{ MKGUI_LABEL,    ID_TEXT_LBL,  "Notes:",            "", ID_TREE_RVBOX, 0, 20, MKGUI_FIXED, 0 },
		{ MKGUI_TEXTAREA, ID_TEXTAREA1, "",                  "", ID_TREE_RVBOX, 0, 0, 0, 1 },

		/* ---- Data Views tab ---- */
		{ MKGUI_VSPLIT,   ID_DATA_SPLIT,"",                  "", ID_TAB_DATA, 0, 0, 0, 0 },
		{ MKGUI_VBOX,     ID_DATA_LVBOX,"",                  "", ID_DATA_SPLIT, 0, 0, MKGUI_REGION_LEFT, 0 },
		{ MKGUI_LABEL,    ID_LV_LBL,   "Listview (1M rows):", "", ID_DATA_LVBOX, 0, 20, MKGUI_FIXED, 0 },
		{ MKGUI_LISTVIEW, ID_LISTVIEW1, "",                  "", ID_DATA_LVBOX, 0, 0, 0, 1 },
		{ MKGUI_VBOX,     ID_DATA_RVBOX,"",                  "", ID_DATA_SPLIT, 0, 0, MKGUI_REGION_RIGHT, 0 },
		{ MKGUI_LABEL,    ID_GV_LBL,   "Gridview:",         "", ID_DATA_RVBOX, 0, 20, MKGUI_FIXED, 0 },
		{ MKGUI_GRIDVIEW, ID_GRIDVIEW1, "",                  "", ID_DATA_RVBOX, 0, 120, MKGUI_FIXED, 0 },
		{ MKGUI_LABEL,    ID_RL_LBL,   "RichList:",         "", ID_DATA_RVBOX, 0, 20, MKGUI_FIXED, 0 },
		{ MKGUI_RICHLIST, ID_RICHLIST1, "",                  "", ID_DATA_RVBOX, 0, 0, 0, 1 },
		{ MKGUI_HBOX,     ID_IV_HBOX,   "",                  "", ID_DATA_RVBOX, 0, 24, MKGUI_FIXED, 0 },
		{ MKGUI_BUTTON,   ID_IV_ICON,   "Icons",             "", ID_IV_HBOX, 0, 0, 0, 1 },
		{ MKGUI_BUTTON,   ID_IV_THUMB,  "Thumbs",            "", ID_IV_HBOX, 0, 0, 0, 1 },
		{ MKGUI_BUTTON,   ID_IV_COMPACT,"Compact",           "", ID_IV_HBOX, 0, 0, 0, 1 },
		{ MKGUI_BUTTON,   ID_IV_DETAIL, "Detail",            "", ID_IV_HBOX, 0, 0, 0, 1 },
		{ MKGUI_ITEMVIEW, ID_ITEMVIEW1, "",                  "", ID_DATA_RVBOX, 0, 0, 0, 1 },

		/* ---- Layout tab ---- */
		{ MKGUI_HBOX,     ID_LAY_HBOX,  "",                  "", ID_TAB_LAYOUT, 0, 0, 0, 0 },
		{ MKGUI_VBOX,     ID_LAY_VBOX,  "",                  "", ID_LAY_HBOX, 200, 0, MKGUI_PANEL_BORDER | MKGUI_FIXED, 0 },
		{ MKGUI_BUTTON,   ID_VBOX_BTN1, "First",             "file-plus",    ID_LAY_VBOX, 0, 28, MKGUI_FIXED, 0 },
		{ MKGUI_BUTTON,   ID_VBOX_BTN2, "Second",            "content-save", ID_LAY_VBOX, 0, 28, MKGUI_FIXED, 0 },
		{ MKGUI_INPUT,    ID_VBOX_INPUT,"",                  "", ID_LAY_VBOX, 0, 24, MKGUI_FIXED, 0 },
		{ MKGUI_SPACER,   ID_VBOX_SPACER,"",                 "", ID_LAY_VBOX, 0, 0, 0, 1 },
		{ MKGUI_BUTTON,   ID_VBOX_BTN3, "Bottom (after spacer)", "", ID_LAY_VBOX, 0, 28, MKGUI_FIXED, 0 },
		{ MKGUI_FORM,     ID_LAY_FORM,  "",                  "", ID_LAY_HBOX, 0, 0, MKGUI_PANEL_BORDER, 1 },
		{ MKGUI_LABEL,    ID_FORM_LBL1, "Name:",             "", ID_LAY_FORM, 0, 0, 0, 0 },
		{ MKGUI_INPUT,    ID_FORM_INP1, "",                  "", ID_LAY_FORM, 0, 0, 0, 0 },
		{ MKGUI_LABEL,    ID_FORM_LBL2, "Email address:",    "", ID_LAY_FORM, 0, 0, 0, 0 },
		{ MKGUI_INPUT,    ID_FORM_INP2, "",                  "", ID_LAY_FORM, 0, 0, 0, 0 },
		{ MKGUI_LABEL,    ID_FORM_LBL3, "Category:",         "", ID_LAY_FORM, 0, 0, 0, 0 },
		{ MKGUI_DROPDOWN, ID_FORM_DRP1, "",                  "", ID_LAY_FORM, 0, 0, 0, 0 },
		{ MKGUI_LABEL,    ID_FORM_LBL4, "Subscribe:",        "", ID_LAY_FORM, 0, 0, 0, 0 },
		{ MKGUI_CHECKBOX, ID_FORM_CHK1, "Yes",               "", ID_LAY_FORM, 0, 0, 0, 0 },

		/* ---- Media tab ---- */
		{ MKGUI_HBOX,     ID_MEDIA_HBOX,"",                  "", ID_TAB_MEDIA, 0, 0, 0, 0 },
		{ MKGUI_VBOX,     ID_MEDIA_LVBOX,"",                 "", ID_MEDIA_HBOX, 320, 0, MKGUI_FIXED, 0 },
		{ MKGUI_PANEL,    ID_PANEL1,    "",                  "", ID_MEDIA_LVBOX, 0, 80, MKGUI_PANEL_BORDER | MKGUI_PANEL_SUNKEN | MKGUI_FIXED, 0 },
		{ MKGUI_LABEL,    ID_PANEL_LBL, "Panel container:",  "", ID_PANEL1, 200, 20, 0, 0 },
		{ MKGUI_BUTTON,   ID_PANEL_BTN, "Inside Panel",      "", ID_PANEL1, 120, 28, 0, 0 },
		{ MKGUI_LABEL,    ID_PATH_LBL,  "Pathbar:",          "", ID_MEDIA_LVBOX, 0, 20, MKGUI_FIXED, 0 },
		{ MKGUI_PATHBAR,  ID_PATHBAR1,  "",                  "", ID_MEDIA_LVBOX, 0, 24, MKGUI_FIXED, 0 },
		{ MKGUI_LABEL,    ID_SB_LBL,    "Scrollbar:",        "", ID_MEDIA_LVBOX, 0, 20, MKGUI_FIXED, 0 },
		{ MKGUI_SCROLLBAR,ID_SCROLLBAR1,"",                  "", ID_MEDIA_LVBOX, MKGUI_SCROLLBAR_W, 0, MKGUI_VERTICAL, 1 },
		{ MKGUI_VBOX,     ID_MEDIA_RVBOX,"",                 "", ID_MEDIA_HBOX, 0, 0, 0, 1 },
		{ MKGUI_LABEL,    ID_CANVAS_LBL,"Canvas:",           "", ID_MEDIA_RVBOX, 0, 20, MKGUI_FIXED, 0 },
		{ MKGUI_CANVAS,   ID_CANVAS1,   "",                  "", ID_MEDIA_RVBOX, 0, 120, MKGUI_PANEL_BORDER | MKGUI_FIXED, 0 },
		{ MKGUI_LABEL,    ID_IMG_LBL,   "Image:",            "", ID_MEDIA_RVBOX, 0, 20, MKGUI_FIXED, 0 },
		{ MKGUI_IMAGE,    ID_IMAGE1,    "",                  "", ID_MEDIA_RVBOX, 0, 120, MKGUI_PANEL_BORDER | MKGUI_FIXED, 0 },
		{ MKGUI_LABEL,    ID_GL_LBL,    "OpenGL:",           "", ID_MEDIA_RVBOX, 0, 20, MKGUI_FIXED, 0 },
		{ MKGUI_GLVIEW,   ID_GLVIEW1,   "",                  "", ID_MEDIA_RVBOX, 0, 0, MKGUI_PANEL_BORDER, 1 },

		{ MKGUI_STATUSBAR, ID_STATUSBAR, "Ready",            "", ID_WINDOW, 0, 0, 0, 0 },
	};
