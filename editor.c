...
static struct ed_type_event_map ed_type_events[] = {
	...
	{ MKGUI_GRIDVIEW,  { MKGUI_EVENT_GRID_CLICK, MKGUI_EVENT_GRID_CHECK, MKGUI_EVENT_GRIDVIEW_SELECT, MKGUI_EVENT_CONTEXT, MKGUI_EVENT_CONTEXT_HEADER, MKGUI_EVENT_FOCUS, MKGUI_EVENT_UNFOCUS, MKGUI_EVENT_HOVER_ENTER, MKGUI_EVENT_HOVER_LEAVE, MKGUI_EVENT_KEY }, 10 },
