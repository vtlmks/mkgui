...
static int32_t svg_rasterize_icon_ex(const char *name, const char *svg_data, uint32_t svg_len, int32_t target_size, uint32_t theme_text_color, uint32_t snap_native) {
